...
class CarrfourBrowser(MarketApi):
    ...
    # (category_id, size)
    PRODUCT_MAP = {
        '常溫商品': [(469, 35), (470, 35), (471, 35),
                 (2963, 35), (2964, 35), (2965, 35), (468, 35),
                 (444, 35), (440, 35), (433, 35), (434, 35), (428, 35), (438, 35), (429, 35), (511, 35),
                 (497, 35), (498, 35), (496, 35),
                 (450, 35), (453, 35), (454, 35), (451, 35), (455, 35),
                 (506, 35), (507, 35), (508, 35), (509, 35), (510, 35), (512, 35),
                 (528, 35), (529, 35), (530, 35)],
        '冷藏商品': [(466, 35), (366, 35), (49, 35),
                 (12, 35), (17, 35), (52, 35), (66, 35),
                 (69, 35)],
        '冷凍食品': [(9, 35), (3034, 35)],
        ...
        '水果': [(231, 70)],
        '雜貨': [(471, 100), (522, 20),(524, 20), (527, 20)]
    }
...
class Rtmart(HonestBee):
    ...
    PRODUCT_MAP = {
        '常溫商品': [(9280, [48426], 1),
                 (9280, [48425], 1), (9280, [48424], 1),
                 (9279, [48418], 1), (9279, [48415], 1), (9279, [48421], 1), (9279, [48419], 1),
                 (9277, [48399], 1), (6981, [70932], 1), (6981, [70932], 1),
                 (9277, [48395], 1), (9277, [48397], 1), (9277, [48396], 1), (9277, [48401], 1), (9277, [48405], 1), (9277, [48406], 1), (9277, [48400], 1), (9277, [48399], 1), (9277, [48404], 1), (9277, [48402], 1),
                 (6981, 35764)],
...
class Carrefour(HonestBee):
    ...
    PRODUCT_MAP = {
        '常溫商品': [(7203, ['37472'], 2), (7203, ['37473'], 2),
                 (7203, ['37473'], 10), (7203, ['37474'], 2),
                 (7203, ['37468'], 1), (7203, ['37471'], 1), (7203, ['37470'], 10)],
        '冷藏商品': [(7204, ['37478'], 2), (7204, ['37479'], 1), (7204, ['37481'], 1), (7204, ['37477'], 1),
